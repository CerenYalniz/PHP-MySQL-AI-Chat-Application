...
> Bu proje, mobil yapay zekâ yaklaşımlarını (On-Device ML, TensorFlow Lite, Flutter) **bilgilendirici web sayfaları** üzerinden açıklayan ve bu mimarilerin
 **uygulamalı örneği olarak PHP & MySQL tabanlı Google Gemini API chatbot demo’su**  içeren web tabanlı bir çalışmadır.
